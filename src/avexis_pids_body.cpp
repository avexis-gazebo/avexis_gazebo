...
void AvexisBodyPids::Init(const ros::NodeHandle &_node, ros::Duration&_dt, const std::vector<std::string>&_controlled_axes)
{
    pid_node_ = _node;
    // init dt from rate
    dt_ = _dt;
...
void AvexisBodyPids::SetpointCallBack(const avexis_gazebo::BodySetpointConstPtr &_msg)
{
...
void AvexisBodyPids::MeasureCallBack(const nav_msgs::OdometryConstPtr &_msg)
{
