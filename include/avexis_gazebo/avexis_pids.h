...
protected:
    ...
    void InitSwitchServices(const std::string &_name)
    {
        ...
        position_service_ = pid_node_.advertiseService<std_srvs::EmptyRequest, std_srvs::EmptyResponse>(_name + "_position_control", boost::bind(&AvexisPids::ToPositionControl, this, _1, _2));
        velocity_service_ = pid_node_.advertiseService<std_srvs::EmptyRequest, std_srvs::EmptyResponse>(_name + "_velocity_control", boost::bind(&AvexisPids::ToVelocityControl, this, _1, _2));
    }
