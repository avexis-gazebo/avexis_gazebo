#ifndef AVEXISBODYPID_H
#define AVEXISBODYPID_H
...
class AvexisBodyPids : public AvexisPids
{
...
public:
    ...
    void SetpointCallBack(const avexis_gazebo::BodySetpointConstPtr & _msg);
