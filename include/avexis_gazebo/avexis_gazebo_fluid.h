#ifndef AvexisGAZEBOFLUID_H
#define AvexisGAZEBOFLUID_H
...
class AvexisFluidPlugin : public  WorldPlugin
{
public:
    AvexisFluidPlugin() {}
    ~AvexisFluidPlugin()
...
GZ_REGISTER_WORLD_PLUGIN(AvexisFluidPlugin)
}
#endif // AvexisGAZEBOFLUID_H
