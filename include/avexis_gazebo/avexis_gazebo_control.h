#ifndef AVEXISGAZEBOCONTROL_H
#define AVEXISGAZEBOCONTROL_H
...
class AvexisControlPlugin : public ModelPlugin
{
public:
    AvexisControlPlugin() {}
    ~AvexisControlPlugin()
...
GZ_REGISTER_MODEL_PLUGIN(AvexisControlPlugin)
}
#endif // avexisGAZEBOCONTROL_H
